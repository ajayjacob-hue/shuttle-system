...
![Tech Stack](https://img.shields.io/badge/Tech_Stack-Capacitor%20%7C%20Node.js%20%7C%20MongoDB-orange)
...
4. **Mobile App Build (Capacitor)**
   Ensure the frontend API calls are pointed correctly to your backend URL (e.g., your Render production URL or localhost for local testing).
   ```bash
